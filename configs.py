...
class Config(object):
    API_ID = int(os.getenv("API_ID", "59057034560"))
    API_HASH = os.getenv("API_HASH", "87f3c59057034560e3e9e404954a39f2")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "6120424017:AAGx6OEqJa6ZgqZIlF4v1-8TmrHGn3rP65Y")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "lovelyavimuwal")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "")
#   Channel id where your posts are stored.
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001943363339")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Avimuwalbot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "6182839487"))
#   OWNER_USERNAME = os.getenv("OWNER_USERNAME", "lovelyavimuwal")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "student_movies")
#    GROUP_USERNAME = os.getenv("modern_movies_group")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001852714321")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://avimuwal1:avi19102005@cluster0.8nvjfah.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001782419622"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "student_movies")
    FORCE_SUB = os.getenv("FORCE_SUB", "True")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 120))
    MDISK_API = os.getenv("MDISK_API", "A1WHsqkwZEA3fLO3sOgq")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ  <a href='https://t.me/student_movies'>students_movies</a> 🤖""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
...
ʀᴇɢᴀʀᴅs - <a href='https://t.me/lovelyavimuwal'>lovelyavimuwal</a>"""
    ABOUT_MDISK_TEXT = """
...
👉 <a href='https://t.me/lovelyavimuwal'>lovelyavimuwal</a>
